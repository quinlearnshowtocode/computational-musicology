...
#empty list to store the most representative track for each language
...
for (lang in names(representative_tracks)) {
  ...
  track_id <- representative_track$id  
  
  print(paste("Language:", lang, "- Most representative track:", track_id))
}
```
...
```{r}
hiphop_knn |> get_conf_mat() |> autoplot(type = "heatmap")
```
